...
(async () => {
  ...
  await page.goto('https://8080-fadcbeeabebafabcdcafbcafaafdfd.project.examly.io');
  ...
  await page1.goto('https://8081-fadcbeeabebafabcdcafbcafaafdfd.project.examly.io');
